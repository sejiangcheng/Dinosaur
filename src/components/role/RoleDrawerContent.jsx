...
import WarningBar from "@/shared/components/warning-bar";
  ...
  const getpackageTitle = currentPackage => {
    ...
    return (
      <>
        ...
        {packageIsSelected ? <span className="primary-color">已选</span> : null}
      </>
    );
  };
  return (
    <>
      {currentEditedRole && currentEditedRole.isUsed && (
        <WarningBar message="该角色已被使用，一旦修改将更新相关用户的功能权限" />
      )}
